...
const QuizSessionSchema = new mongoose_1.Schema({
    code: {
        type: String,
        required: true,
...
const QuizSessionModel = mongoose_1.default.model("QuizSession", QuizSessionSchema);
exports.default = QuizSessionModel;
